...
$name = $_REQUEST['name'];				// takes the name from the contact form 
$email = $_REQUEST['email'];				// takes the e-mail from the contact form
...
$mail->Subject = 'contact form from: ' . $email ;	// $email variable set above from contact form
$mail->Body    = $message;				// $message variable set above from contact form
